    ...
    <footer className="bg-[#05070C] border-t border-white/5 pt-20 pb-12 transition-colors">
      <div className="container mx-auto px-4">
          ...
          <div className="md:col-span-4 grid grid-cols-2 gap-8">
             <div>
               ...
               <ul className="space-y-6 text-[11px] font-black text-slate-500 tracking-widest">
                 <li><button onClick={() => onNavigate('best-sellers')} className="hover:text-white transition-colors">Best Sellers</button></li>
                 <li><button onClick={() => onNavigate('gaming')} className="hover:text-white transition-colors">Gaming</button></li>
                 <li><button onClick={() => onNavigate('business')} className="hover:text-white transition-colors">Business</button></li>
                 <li><button onClick={() => onNavigate('comparison-tool')} className="hover:text-white transition-colors">Comparison</button></li>
               </ul>
             </div>
             <div>
               <h4 className="text-white font-black uppercase text-[10px] tracking-[0.3em] mb-10 brand-font">Protocols</h4>
               <ul className="space-y-6 text-[11px] font-black text-slate-500 tracking-widest">
                 <li><button onClick={() => onNavigate('shipping')} className="hover:text-white transition-colors">Shipping</button></li>
                 <li><button onClick={() => onNavigate('returns')} className="hover:text-white transition-colors">Returns</button></li>
                 <li><button onClick={() => onNavigate('warranty')} className="hover:text-white transition-colors">Warranty</button></li>
                 <li><button onClick={() => onNavigate('track')} className="hover:text-white transition-colors">Tracking</button></li>
               </ul>
             </div>
          </div>
        ...
        <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] font-black text-slate-600 uppercase tracking-widest">
          <p>© 2025 NOVA TREND. UNIFIED TECHNICAL REGISTRY. SEC PROTOCOL v1.1</p>
