      ...
      <div className="max-w-7xl w-full mx-auto z-10 relative">
        <motion.div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-syne font-black tracking-tighter text-black leading-[0.8] mb-8">
            <KineticText>DIGITAL</KineticText> <br />
            <span className="text-white">
              <KineticText>ALCHEMY</KineticText>
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-primary font-medium max-w-2xl leading-relaxed mb-12">
            We engineer growth for SMEs through custom SaaS and precision marketing. Enterprise-grade power, tailored for you.
          </p>
          <Magnetic>
            <Link
              href="/portfolio"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
            <ServiceCard
              ...
              desc="Custom platforms that streamline your business."
            />
            <ServiceCard
              icon={<Zap className="w-8 h-8" />}
              title="Growth Marketing"
              desc="SEO & Ads that drive measurable ROI."
              className="md:translate-y-12"
            />
            <ServiceCard
              icon={<Layout className="w-8 h-8" />}
              title="Experience Design"
              desc="Intuitive UI/UX for web and mobile."
            />
            <ServiceCard
              icon={<ArrowUpRight className="w-8 h-8" />}
              title="Brand Strategy"
              desc="Positioning your business for success."
              className="md:translate-y-12"
            />
          </div>
        </div>
