...
export default function Team() {
    const [founders, setFounders] = useState<any[]>(INITIAL_FOUNDERS);
    const [squad, setSquad] = useState<any[]>(INITIAL_SQUAD);
    ...
    useEffect(() => {
        fetch("/api/content.php")
            ...
            .catch(err => console.error("CMS Load Error (Team)", err));
    }, []);
