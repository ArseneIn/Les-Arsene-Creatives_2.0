        ...
        <aside className="flex w-72 flex-col bg-gradient-to-b from-primary-900 to-primary-950 h-full shadow-2xl z-20 transition-all flex-shrink-0 relative overflow-hidden">
            ...
            <div className="relative flex-1 overflow-y-auto px-4 py-2 custom-scrollbar z-10">
                <nav className="flex flex-col gap-1.5">
                    ...
                    <Link href="/school-dashboard" className="group flex items-center gap-3 px-3 py-3 rounded-lg bg-white/10 text-white shadow-lg shadow-black/5 ring-1 ring-white/20 backdrop-blur-md transition-all hover:bg-white/20">
                    ...
                    <details className="group/accordion rounded-lg open:bg-white/5 transition-colors">
                        ...
                        <div className="flex flex-col gap-1 pl-11 pr-2 pb-2 mt-1">
                            <Link href="/school-dashboard/timetable" className="flex items-center gap-2 px-3 py-2 rounded-md text-primary-200 hover:text-white hover:bg-white/10 text-sm font-medium transition-colors">
                                <span className="material-symbols-outlined" style={{ fontSize: '18px' }}>calendar_month</span>
                                Timetable
                            </Link>
                            <Link href="/school-dashboard/teachers" className="flex items-center gap-2 px-3 py-2 rounded-md text-primary-200 hover:text-white hover:bg-white/10 text-sm font-medium transition-colors">
                                <span className="material-symbols-outlined" style={{ fontSize: '18px' }}>person_apron</span>
                                Teachers
                            </Link>
                            <Link href="/school-dashboard/students" className="flex items-center gap-2 px-3 py-2 rounded-md text-primary-200 hover:text-white hover:bg-white/10 text-sm font-medium transition-colors">
                    ...
                    {/* Attendance (New) */}
                    <Link href="/attendance" className="flex items-center gap-3 px-3 py-3 rounded-lg text-primary-100 hover:bg-white/10 hover:text-white transition-all">
                    ...
                    {/* Finance */}
                    <Link href="/school-dashboard/finance" className="flex items-center gap-3 px-3 py-3 rounded-lg text-primary-100 hover:bg-white/10 hover:text-white transition-all">
                    ...
                    {/* Library */}
                    <Link href="/school-dashboard/library" className="flex items-center gap-3 px-3 py-3 rounded-lg text-primary-100 hover:bg-white/10 hover:text-white transition-all">
                    ...
                    {/* System & Compliance */}
                    <Link href="/school-dashboard/system" className="flex items-center gap-3 px-3 py-3 rounded-lg text-primary-100 hover:bg-white/10 hover:text-white transition-all">
            ...
            <div className="relative p-4 border-t border-white/10 bg-primary-950/50 shadow-[0_-10px_20px_-5px_rgba(0,0,0,0.2)] z-10">
                {/* Role Switcher */}
                <div className="mb-4">
                    <label className="block text-primary-200 text-xs font-medium mb-1.5 ml-1">View as</label>
                    <div className="relative group/select">
                        ...
                        <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-primary-200">
                            <span className="material-symbols-outlined" style={{ fontSize: '20px' }}>swap_horiz</span>
                        </div>
                        <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 text-primary-200">
                ...
                <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-white/10 transition-colors cursor-pointer group/profile">
                    <div className="relative">
                        <div className="bg-center bg-no-repeat bg-cover rounded-full size-10 ring-2 ring-white/20" data-alt="Portrait of a professional administrator" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAQTrshfoao6N8RNmZVE7lHNteQnY7pRT4LRBqaKjQnWdKkF5SuE06QA_fnSmZLh3fK6FuGAOnKgtULyFTNRGoa0ZQpLxq5v8IaVnSWRq7tmVv4ubEf91lilIfXLzJ6iqA92_zd3PoJtxiIvfTFuZd8wj8tk95sK9SS9fXreqNRpOrNkfD95_F8R-q7dZb7Ra2dup40BMvJB7ON6hZd0hX6sLuaSK0w2QSxhGbZJVDF2243nkNMhqlUldRAcY24_FRCbdDtptzLanI5")' }}>
                        </div>
                    ...
                    <div className="flex flex-col min-w-0 flex-1">
                        ...
                        <p className="text-primary-200 text-xs truncate">Super Admin</p>
                    </div>
                    <Link href="/login" className="text-primary-300 hover:text-white p-1 rounded-md hover:bg-white/10 transition-colors">
